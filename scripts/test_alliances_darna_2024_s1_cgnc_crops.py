...
PDF_PATH = next(ROOT.glob("*metteur/alliances_darna_2024_s1.pdf"))
COMPANY = "Alliances Darna"
YEAR = 2024
SECTOR = "autres_cgnc"
SCOPES = ["comptes_consolides", "comptes_sociaux"]
TARGETS = ["BILAN_ACTIF", "BILAN_PASSIF", "CPC"]
OUT_ROOT = ROOT / "output" / "financial_extraction_debug" / "alliances_darna_2024_s1_cgnc"
