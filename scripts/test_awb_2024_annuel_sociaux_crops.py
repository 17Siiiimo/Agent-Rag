...
PDF_PATH = ROOT / "Émetteur" / "attijariwafa_bank_2024_annuel.pdf"
COMPANY = "Attijariwafa Bank"
YEAR = 2024
SCOPE = "comptes_sociaux"
SECTOR = "bancaire_sdf"
TARGETS = ["BILAN_ACTIF", "BILAN_PASSIF", "CPC"]
OUT_ROOT = ROOT / "output" / "financial_extraction_debug" / "awb_2024_annuel_sociaux"
...
def main() -> int:
    ...
    for target_table in TARGETS:
        ...
        if selected and selected_page:
            ...
            if needs_combined:
                warnings.append("selected page contains multiple target candidates; verify crop separation")
        else:
        ...
        write_json(target_dir / "selected_page.json", selected_payload)
